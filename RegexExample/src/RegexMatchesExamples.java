public class RegexMatchesExamples {
    public static void main(String[] args) {
        new RegexMatchesExamples().run();
    }
 
    private void run() {
        // A Stringeknek van egy matches nevű metódusa, amiben reguláris kifejezések alapján is lehet egyeztést keresni
    ...
    private boolean isOnlyThreeCapitalLetters(String text) {
        // itt most csak nagybetűk keresünk, három darab engedélyezett
        return text.matches("[A-Z]{3}+");
    }
 
    private boolean isThreeToFiveDigits(String text) {
        // itt csak számokat engeedélyezünk 3 és 5 közötti darabszámra
